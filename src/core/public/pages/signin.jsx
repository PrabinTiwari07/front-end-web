                ...
                <form>
                    ...
                    <div className="form-control mb-4 relative">
                        ...
                        <input
                            ...
                            className="input input-bordered focus:outline-none focus:ring-2 focus:ring-teal-500 pr-12"
                            required
                        />
                        {/* Eye Icon */}
                        <span
                            className="absolute top-10 right-3 cursor-pointer text-gray-600 hover:text-gray-800"
